...
\small Version 1.0.5\\[1pt]
\small DOI \href{https://doi.org/10.5281/zenodo.22601333}{10.5281/zenodo.22601333} (all versions)}
\date{12 September 2026\\[3pt]
...
\begin{remark}[the first report's withdrawal, and what it does not touch]
\label{r:firstwithdrawal}
\textup{[P], added in version~1.0.5.}  \cite{First} has withdrawn, in its
version~0.1.7, the source application under which the values $8/7$ and $88/7$
were read as an incompatibility with \cite{IUT4}; see \cite[\S7]{First}, which
gives the source locators and a proposition limiting the scope of that
withdrawal to the mechanism used there.  \emph{No statement of the present report
used that application.}  The columns above are $\mathrm{co}$ and $\mathrm{bd}$ as
defined in this section, and \S\ref{s:container} states that an exponent alone
does not name a set; the scope paragraph of the abstract already recorded that
nothing here is conditional on \SA{}.  The numerical values are unchanged, and
nothing in this report is withdrawn.
\end{remark}
