...
\small DOI \href{https://doi.org/10.5281/zenodo.22601335}{10.5281/zenodo.22601335}}
\date{Version 0.2.0-draft --- \today\\[3pt]
...
exact and reproduced by a short script, and the geometric conditions (d)--(f) are
established in \S\ref{s:geom}.  The local invariants are $e_{\mathrm g}=1$,
$e_{\mathrm b}=105$ and
...
reporting $5525$ curves of prime conductor for which some $\ell$ works.  The datum below is over
...
\textup{[S]} \cite{DH25} does this over $\mathbb{Q}$: it breaks
...
surjective --- that one condition, not the whole of \cite[Def.~3.1]{IUT1}.  \textup{[P]} \emph{Over $\mathbb{Q}$ the mixed
...
formula, not a licensed comparison}: at 11a1
$e_{\mathrm b}=105/\gcd(105,5)=21>p-2=9$; at 14a1 $p=\ell$
(which \cite[Def.~3.1(c)]{IUT1} does not allow at a bad place at all), at 15a1
$p\mid15$, and at 37a1 $e_{\mathrm b}=105>35$.  They are printed to show the scale of
$\ord_p(q)$ on record, nothing more.
...
reduced search is external to this report.  The rows above should be read accordingly.
...
that any estimate is; that the $abc$ conjecture or any statement of
...
$q\nmid M$, the case $q=p$ was missing, and external review, not the kernel, found it.
...
argument of \S\ref{s:arith}; the omission was found in external review and is
...
tabulations of \S\ref{s:margin}--\S\ref{s:slack} were withdrawn after external
review: an incorrect ramification index, an omitted hypothesis of
