...
\date{Version 1.0.2 --- 7 September 2026\\[3pt]
\small ORCID \href{https://orcid.org/0009-0004-0460-6242}{\texttt{0009-0004-0460-6242}}\\[3pt]
\small DOI \href{https://doi.org/10.5281/zenodo.22646136}{10.5281/zenodo.22646136} (all versions)}
...
misdescribed Step (viii) (found in a later review, 2026-09-07).  \textup{[P]} Take the curve
\texttt{5190c3}, with
\[
...
Assume $e_{\mathrm g}=1$, $c_{\mathrm b}>0$ and $s>0$, and put $r=s/c_{\mathrm b}$ and
\[
 E_m=\Bigl\{\tfrac{d}{j^{2}}:1\le j\le m,\ 1\le d\le j+1\Bigr\}\cup
      \Bigl\{\tfrac{d}{k^{2}-j^{2}}:1\le j<k\le m,\ 1\le d\le k\Bigr\}.
\]
Then \emph{the induced map is injective
...
group $c_{\mathrm b}>0$ separates.  \emph{This criterion arose in an internal check of the present note.}
...
in error; that any estimate in those papers is affected; any conclusion about the $abc$ inequality; that the
...
\bibitem[Second]{Second} T.~Urahigashi, \emph{An initial $\Theta$-datum over an
 ...
 DOI \href{https://doi.org/10.5281/zenodo.22601333}{10.5281/zenodo.22601333}
 (all versions).
