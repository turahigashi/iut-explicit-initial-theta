...
We restate \S\ref{sec:notclaim} now that the statements have been made.
Theorems~\ref{thm:local} and \ref{thm:averaged} concern the application of a
local upper bound to the fixed target component of the union of possible images.
They do not bear on the truth of $abc$, on the lower bound of
\cite[Corollary 3.12]{IUT3}, on the global inequality of
\cite[Theorem 1.10]{IUT4}, or on the merits of \cite{SS} versus \cite{Rpt2018}.
They also do not show that the estimates cannot be repaired: an enlarged
container is permitted by \cite{IUT4}, and the question is whether the
accompanying loss of volume can be carried through the subsequent averaging.
