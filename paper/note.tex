...
\date{Version 0.1.2-draft --- \today\\[3pt]
\small DOI \href{https://doi.org/10.5281/zenodo.22537343}{\texttt{10.5281/zenodo.22537343}}\qquad ORCID \href{https://orcid.org/0009-0004-0460-6242}{\texttt{0009-0004-0460-6242}}}
...
We ask how the admitted configuration is treated (Question~\ref{q:hyp}).  All
arithmetic is exact and is reproduced by a short script.
\end{abstract}
...
theory; \cite{MFHMP} is devoted to obtaining such uses.  This note contributes one,
...
A detailed expansion is in \cite[\S\S3--5, especially \S4.6]{Full}.
...
\cite[\S4.6]{Full}.  This existence uses neither \SA{} nor a numerical
...
The fuller source-to-hull argument is recorded in \cite[\S\S7--8]{Full}.
...
The companion package \cite{Full} separates the checks from the source
...
\S\ref{s:datum}, expanded in \cite[\S4]{Full}.
...
\bibitem[Full]{Full} T.~Urahigashi, \emph{An explicit initial $\Theta$-datum
 ...
 0.1.2-draft (2026).  Included as \href{paper.pdf}{\texttt{paper.pdf}},
